...
, zone_id = None Text
, access_logs =
    None (List ./../../types/aws_alb/block_types/access_logs/main.dhall)
, subnet_mapping =
    None (List ./../../types/aws_alb/block_types/subnet_mapping/main.dhall)
, timeouts = None ./../../types/aws_alb/block_types/timeouts/main.dhall
}
