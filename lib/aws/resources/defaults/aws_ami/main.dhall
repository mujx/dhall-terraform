...
, ebs_block_device =
    None (List ./../../types/aws_ami/block_types/ebs_block_device/main.dhall)
, ephemeral_block_device =
    None
      (List ./../../types/aws_ami/block_types/ephemeral_block_device/main.dhall)
, timeouts = None ./../../types/aws_ami/block_types/timeouts/main.dhall
}
